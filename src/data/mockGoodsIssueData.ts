...
export const mockGoodsIssues: GoodsIssue[] = [
  {
    ...
    partner_address: '124 Nguyen Duc Canh, District 7, HCMC',
    related_entry: 'SO-2024-2045',
    remarks: 'Priority delivery for weekend promotion',
  ...
  },
  {
    ...
    partner_address: '456 Nguyen Trai, District 1, HCMC',
    related_entry: 'SO-2024-1990',
  ...
  },
  {
    ...
    remarks: 'Adjust variance from 17 June cycle count',
    from_wh_name: 'Central WH',
  ...
  },
  {
    ...
    related_entry: 'TO-2024-004',
    remarks: 'Awaiting approval from destination warehouse',
    from_wh_name: 'Central WH',
  ...
  },
  {
    ...
    partner_address: '12 Street 5, Thu Duc City',
    remarks: 'Expired products - coordinate with QA on pickup',
  ...
  },
  {
    ...
    related_entry: 'ADJ-2024-776',
    remarks: 'Disposal completed with QA witness',
    from_wh_name: 'Central WH',
  ...
  },
  {
    ...
    partner_address: '23A Le Loi, District 3, HCMC',
    related_entry: 'SO-2024-2101',
    remarks: 'Cancelled per customer request - do not reschedule',
